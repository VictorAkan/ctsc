...
const sizes = {
    "20xl": "text-[2.1rem] font-medium md:text-[1.8rem] sm:text-[1.8rem]",
    ...
    "14xl": "text-[1.3rem] font-normal md:text-[1.35rem] sm:text-[0.99rem]", 
    ...
    "9xl": "text-[1rem] sm:text-[1rem] md:text-[1.2rem] font-medium",
    "10xl": "text-[1.44rem] font-medium md:text-[1.31rem] sm:text-[1rem]",
    ...
    "7xl": "text-[1rem] font-normal",
    "8xl": "text-[1.0rem] sm:text-[1rem] font-normal",
    "30xl": "text-[5.20rem] font-medium md:text-[3.00rem]",
    "2xl": "text-[0.94rem] font-normal",
    "3xl": "text-[1.00rem] font-medium",
    "4xl": "text-[1.06rem] font-normal",
    s: "text-[0.63rem] font-normal",
    "29xl": "text-[5.5rem] font-light md:text-[3.00rem]",
    "26xl": "text-[2.75rem] font-medium md:text-[2.5rem] sm:text-[1.88rem]", 
    "25xl": "text-[3.56rem] font-light md:text-[3.06rem] sm:text-[2.69rem]", 
    "28xl": "text-[3.38rem] font-normal md:text-[3.00rem]",
    ...
    "21xl": "text-[2.2rem] font-normal md:text-[2.1rem] sm:text-[1.45rem]",
