...
const sizes = {
    ...
    "6xl": "h-[3.81rem] px-[2.00rem] text-[1.2rem]",
    ...
    "12xl": "h-[7.31rem] px-[1.06rem] sm:px-[1.06rem] text-[2.2rem] sm:text-[1.5rem]",
    "11xl": "h-[4.94rem] px-[1.38rem] sm:px-[1rem] text-[1rem] sm:text-[1rem]",
