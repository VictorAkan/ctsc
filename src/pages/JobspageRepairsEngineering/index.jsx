...
export default function JobspageRepairsEngineering() {
    useScrollToTop();
    ...
    useEffect(() => {
        async function fetchJob() {
            try {
                const response = await axios.get("https://crackingthestylecode.pythonanywhere.com/api/v1/job/12/");
    ...
    return (
        <>
            <Helmet>
                <title>Repairs and Engineering Jobs</title>
                <meta name="description" content="Repairs and Engineering job listings" />
            </Helmet>
