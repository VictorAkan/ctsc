        ...
        <>
            ...
            <div className="w-full bg-[#ffffff] pb-[4.38rem] md:pb-[1.25rem]">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="mt-[-27.88rem] rounded-[69px] bg-[#f7f6f6] pb-[16.81rem] pl-[2.50rem] p-[2.56rem] pt-[3.31rem] md:w-full md:py-[1.25rem] md:pr-[1.25rem] sm:p-[0.5rem]">
                        <div className="flex flex-col gap-[7.00rem] md:gap-[5.25rem] sm:gap-[3.50rem]">
                                ...
                                <div className="flex w-[93%] items-center justify-between gap-[1.25rem] md:w-full md:flex-col">
                                    <div className="flex w-[56%] items-center justify-between gap-[1.25rem] md:w-full sm:flex-col">
                                        ...
                                        <div className="flex flex-col items-start gap-[0.31rem]">
                                            <Heading size="3xl" as="h1" className="text-[3.38rem]">
                                                John Emmanuel
                                            </Heading>
                                    ...
                                    <div className="flex w-[30%] items-center justify-center md:w-full">
                                        <img src="images/img_call.svg" alt="call" className="h-[3.50rem] w-[35%] sm:w-[30px]" />
                                        <Img
                                            src="images/upload.png.png"
                                            alt="upload"
                                            className="ml-[6.13rem] h-[3.75rem] md:h-auto w-[53%] md:w-[20%] sm:w-[15%]"
                                        />
                                        <div className="ml-[4.81rem] flex w-[12%] flex-col gap-[0.69rem] sm:h-[60px] sm:w-[12px]">
                                            <div className="h-[1.31rem] w-[1.31rem] rounded-[10px] bg-[#ffffff] sm:h-[10px] sm:w-[10px]" />
                                            <div className="h-[1.31rem] w-[1.31rem] rounded-[10px] bg-[#ffffff] sm:h-[10px] sm:w-[10px]" />
                                            <div className="h-[1.31rem] w-[1.31rem] rounded-[10px] bg-[#ffffff] sm:h-[10px] sm:w-[10px]" />
                                        </div>
                                    </div>
                            ...
                            <div className="container-xs flex flex-col items-end pl-[0.88rem] pr-[1.63rem] md:p-[1.25rem] sm:pr-[1.25rem]">
                                ...
                                <div className="mt-[5.06rem] flex w-[47%] rounded-bl-[61px] rounded-br-[47px] rounded-tr-[34px] bg-[#ffffff] px-[2.38rem] pb-[2.19rem] pt-[2.81rem] md:w-full md:pt-[1.25rem] sm:p-[1.25rem]">
                                ...
                                <div className="mr-[1.25rem] mt-[2.06rem] flex flex-col items-start self-stretch md:mr-0">
                                    <div className="flex w-[59%] rounded-bl-[61px] rounded-br-[34px] rounded-tr-[47px] bg-[#10348f] pb-[2.31rem] pl-[3.63rem] pr-[3.50rem] pt-[2.69rem] md:w-full md:px-[1.25rem] md:pt-[1.25rem] sm:p-[1.25rem]">
                                    ...
                                    <div className="mt-[0.81rem] flex w-[59%] justify-center self-end rounded-bl-[79px] rounded-br-[47px] rounded-tr-[34px] bg-[#ffffff] px-[2.25rem] pb-[5.19rem] pt-[2.25rem] md:w-full md:pb-[1.25rem] sm:p-[1.25rem]">
                                        <Text size="18xl" as="p" className="!text-[2.13rem] !text-[#000000] sm:!text-xl">
                                    ...
                                    <div className="mt-[0.38rem] flex rounded-bl-[68px] rounded-br-[34px] rounded-tr-[47px] bg-[#10348f] px-[2.13rem] pb-[4.69rem] pt-[2.13rem] md:pb-[1.25rem] sm:p-[1.25rem]">
                                        <Text size="18xl" as="p" className="!text-[2.13rem] sm:!text-xl">
                                            Okay, give me some time to make a schedule so we talk about it.
                                        </Text>
                                    </div>
                                    <Text size="13xl" as="p" className="mt-[0.31rem] !font-['Rubik'] !text-[1.69rem] !text-[#7b7b7b]">
                                        9.27 AM
                                    </Text>
                                    <div className="mt-[13.31rem] flex gap-[2.38rem] sm:gap-1 self-stretch md:flex-col">
                                        <div className="flex flex-1 items-center justify-between gap-[1.25rem] sm:gap-0 md:w-full rounded-[47px] bg-[#a6bbf1] py-[3.38rem] pl-[3.06rem] pr-[35.63rem] md:self-stretch sm:p-1 md:p-[1.25rem]">
                                        ...
                                        <Button
                                            ...
                                            className="w-[9.63rem] rounded-[47px] md:p-[1.25rem]"
                                        >
