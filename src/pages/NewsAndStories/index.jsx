                ...
                {stories?.map((story) => (
                    <div key={story.id} className="flex mt-24 justify-center mb-10">
                        <div className="w-full bg-white p-6 rounded-lg shadow-md">
                            ...
                            <Link to={`/story/${story.id}`} className="block mt-4 text-xl font-bold text-[#253451] hover:text-blue-600">
                                {story.topic}
                            </Link>
                            <p className="mt-2 text-gray-700">
                                {story.short_description}
                            </p>
                            <Link to={`/story/${story.id}`} className="mt-4 inline-block text-blue-500 hover:underline">
                                Read More
                            </Link>
                            <div className="mt-6 flex sm:flex-col items-center">
                                ...
                                />
                                <Button onClick={() => handleCommentSubmit(story.id)} className="bg-[#253451] text-white px-4 py-2 sm:rounded-l-lg rounded-r-lg hover:bg-blue-600">
                                    Post Comment
                                </Button>
                            </div>
                        </div>
