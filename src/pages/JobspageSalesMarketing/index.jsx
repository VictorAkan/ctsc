...
export default function JobspageSalesMarketing() {
    useScrollToTop();
    ...
    useEffect(() => {
        async function fetchJob() {
            try {
                const response = await axios.get("https://crackingthestylecode.pythonanywhere.com/api/v1/job/7/");
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Sales and Marketing job listings" />
            </Helmet>
