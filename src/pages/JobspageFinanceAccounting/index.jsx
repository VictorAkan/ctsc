...
export default function JobspageFinanceAccounting() {
    useScrollToTop();
    ...
    useEffect(() => {
        async function fetchJob() {
            try {
                const response = await axios.get("https://crackingthestylecode.pythonanywhere.com/api/v1/job/9/");
    ...
    return (
        <>
            <Helmet>
                <title>Finance and Accounting Jobs</title>
                <meta name="description" content="Finance and Accounting job listings" />
            </Helmet>
