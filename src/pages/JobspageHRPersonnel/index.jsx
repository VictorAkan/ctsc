...
export default function JobspageHRPersonnel() {
    useScrollToTop();
    ...
    useEffect(() => {
        async function fetchJob() {
            try {
                const response = await axios.get("https://crackingthestylecode.pythonanywhere.com/api/v1/job/13/");
    ...
    return (
        <>
            <Helmet>
                <title>HR Personnel Jobs</title>
                <meta name="description" content="HR Personnel job listings" />
            </Helmet>
