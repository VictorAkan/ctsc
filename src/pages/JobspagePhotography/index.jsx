...
export default function JobspagePhotography() {
    useScrollToTop();
    ...
    useEffect(() => {
        async function fetchJob() {
            try {
                const response = await axios.get("https://crackingthestylecode.pythonanywhere.com/api/v1/job/8/");
    ...
    return (
        <>
            <Helmet>
                <title>Photography Jobs</title>
                <meta name="description" content="Photography job listings" />
            </Helmet>
