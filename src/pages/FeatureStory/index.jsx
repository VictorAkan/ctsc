    ...
    return (
        ...
        <div className="container mx-auto px-10">
            ...
            <div className="pt-20">
                ...
                {story && (
                    <>
                        <p className="mt-5 text-gray-800">{story.introduction}</p>
                        {/* other parts of the story as needed */}
                    </>
                )}
                ...
                {previousStories.length > 0 ? (
                    <ul className="mt-5 text-gray-800">
                        {previousStories.map((prevStory) => (
                            <li key={prevStory.id} className="mt-4">
                                <h3 className="text-xl font-bold">{prevStory.title}</h3>
                                <p>{prevStory.introduction}</p>
