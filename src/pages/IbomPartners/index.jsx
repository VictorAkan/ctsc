...
export default function IbomPartnersPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('https://crackingthestylecode.pythonanywhere.com/api/v1/partner/');
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="mt-[4.38rem] flex w-[91%] items-center md:w-full md:flex-col md:p-[1.25rem]">
                        {partners.length > 0 ? partners.map((partner) => (
                            <div key={partner.id} className="mb-[2.31rem] w-[50%] rounded-[58px] border border-solid border-[#253451] bg-[#f7f7f7] pb-[2.63rem] pl-[1.81rem] pr-[3.13rem] pt-[4.19rem] md:w-full md:py-[1.25rem] md:pr-[1.25rem] sm:p-[1.25rem]">
